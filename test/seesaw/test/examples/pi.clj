...
(def stylesheet {[:JFrame] {:title "Let's Calculate \u03C0!!"}
                 ...
                 [:#result] {:text       (format "\u03C0 = %.20f" 0.0)
                             :border     5
                             :halign     :center
                             :font       "MONOSPACE-BOLD-24"
                             :foreground "#0022DD"}})

(def behaviors {[:#go]     {:action-performed go}
                [:#cancel] {:action-performed cancel}}) (defn apply-stylesheet [root stylesheet]
