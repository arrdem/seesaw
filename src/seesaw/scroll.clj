...
(def ^{:private true} default-handlers {;; TODO preserve current x offset for :top and bottom
                                        :top
                                        (fn [target]
  ...
  ;; TODO :left and :right
                                        ...
                                        (fn [target ^Integer x ^Integer y ^Integer w ^Integer h]
                                          (scroll-rect-to-visible target (java.awt.Rectangle. x y w h)))}) (def ^{:private true} list-handlers {:row
                                                                                                                                                (fn [^javax.swing.JList target ^Integer row]
                                                                                                                                                  (scroll-rect-to-visible target (.getCellBounds target row row)))}) (def ^{:private true} table-handlers {;; TODO preserve current column
                                                                                                                                                                                                                                                           :row
  ...
  ;; TODO preserve current row
                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                           (fn [^javax.swing.JTable target ^Integer row ^Integer column]
                                                                                                                                                                                                                                                             (scroll-rect-to-visible target (.getCellRect target row column false)))}) (defn- text-position-to-rect [^javax.swing.text.JTextComponent target ^Integer position]
                                                                                                                                                                                                                                                                                                                                         (try
...
(def ^{:private true} text-handlers {;; On text, moving the caret is a better way to scroll. Otherwise, you get
  ...
  ;; position
                                     ...
                                     (fn [^javax.swing.text.JTextComponent target ^Integer position]
                                       (if (and (>= position 0) (< position (text-get-end-position target)))
                                         (set-caret-position target position)))}) (defn- lookup-handler [handlers op]
